        ...
        return (
            <div className="introduction-container">
                <div className="title-containt">
                    ...
                    <div className="back-btn" onClick={()=>{this.props.pageChange('Menu')}}>
                        <i className="material-icons">
                            arrow_back
                        </i>
                    </div>
                ...
                <div className="basic-intro">
                    ...
                    <div className="subtitle"> <u>Card Values</u> </div>
                        <p className="paragraph">
                        When playing Blackjack the numeral cards 2 to 10 have their face values, Jacks, Queens and Kings are valued at 10, and Aces can have a value of 10.
                        </p>
                </div>
...
export default connect(null,{pageChange})(Introduction);